...
from sublime.helpers import AuthorRequiredMixin
from sublime.articles.models import Article
from sublime.articles.forms import ArticleForm
...
class CreateArticleView(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        print('---  article form valid ', form.errors)
        form.instance.user = self.request.user
        return super().form_valid(form)

    def form_invalid(self, form):
        print('---  article form invalid ', form.errors)
