...
from sublime.notifications.models import Notification, notification_handler
...
class News(models.Model):
            ...
            if user != self.user:
                notification_handler(
                    user, self.user,
                        ...
                        key='like_news_post',
                        message_text = f'{user.username} liked your news post',
                    )
    ...
    def reply_this(self, user, text):
        ...
        notification_handler(
            ...
            key='reply_news_post',
            message_text = f'{user.username} replied to your news post.',
        ) # social_update
