...
from sublime.users.models import User
...
class MessageQuerySet(models.query.QuerySet):
    ...
    def get_conversation(self, sender, recipient):
        ...
        qs_union = qs_one.union(qs_two).order_by('-timestamp')
        return qs_union
...
class Message(models.Model):
    ...
    def get_absolute_url(self):
        return reverse_lazy('messager:conversation_detail', kwargs = {'username' : self.sender.username})
...
def post_save_message(sender, instance, created, *args, **kwargs):
    if created:
        notification_handler(
            ...
            message_text = f'{instance.sender} replied to your conversation.',
